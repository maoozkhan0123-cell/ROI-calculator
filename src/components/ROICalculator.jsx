        ...
        {step === 5 && (
          <div className="space-y-6 flex-grow">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6 px-1">
               <div className="bg-gray-50 px-2 py-4 rounded-2xl border border-gray-100 text-center shadow-sm">
                <p className="text-[11px] font-semibold text-gray-500 uppercase tracking-wide">Current Annual Cost</p>
                <p className="text-base sm:text-lg lg:text-xl font-bold text-gray-800 mt-2 truncate">
